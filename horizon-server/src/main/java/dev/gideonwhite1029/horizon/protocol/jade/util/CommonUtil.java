package dev.gideonwhite1029.horizon.protocol.jade.util;
...
import dev.gideonwhite1029.horizon.protocol.jade.provider.IServerExtensionProvider;
    ...
    public static <T> Map.Entry<ResourceLocation, List<ViewGroup<T>>> getServerExtensionData(
        ...
        for (var provider : lookup.wrappedGet(accessor)) {
            ...
            try {
                ...
                HorizonLogger.LOGGER.severe(e.toString());
                continue;
            }
            if (groups != null) {
