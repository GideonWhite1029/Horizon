...
mv horizon-server/build/libs/$project_id-paperclip-$mcversion.jar horizon-server/build/libs/$jarName
mv horizon-server/build/libs/$project_id-bundler-$mcversion.jar horizon-server/build/libs/$project_id-$mcversion-bundler.jar
