package dev.gideonwhite1029.horizon.entity.botaction;
...
public class HorizonBotAction {
    ...
    public HorizonBotAction(BotActionType type, int executeInterval, int remainingExecuteTime) {
        this(type.getName(), executeInterval, remainingExecuteTime, UUID.randomUUID());
    }

    public HorizonBotAction(String name, int executeInterval, int remainingExecuteTime) {
        this(name, executeInterval, remainingExecuteTime, UUID.randomUUID());
    }

    protected HorizonBotAction(String name, int executeInterval, int remainingExecuteTime, UUID actionUUID) {
