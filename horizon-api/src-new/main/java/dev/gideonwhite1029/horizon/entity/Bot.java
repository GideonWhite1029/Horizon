package dev.gideonwhite1029.horizon.entity;

import dev.gideonwhite1029.horizon.entity.botaction.HorizonBotAction;
...
public interface Bot extends Player {
     ...
     */
    public void addAction(@NotNull HorizonBotAction action);
     ...
     */
    public HorizonBotAction getAction(int index);
